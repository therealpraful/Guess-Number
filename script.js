...
function getRandomNumber(){
  // *CODE GOES BELOW HERE *
  let randomNumber = Math.floor(Math.random() * 101);     // returns a random integer from 0 to 100
  return randomNumber
}
...
function showNumberInvalid(){
  const text = "Number should be between 1 to 100."
  /**
   * Retrieve the dialog using the getDialog() function
   * and save it to variable called dialog
   * HINT: Use the 'warning' and text parameters 
